package com.brockw.stickwar.engine.units
{
   ...
   public class Skelator extends Unit
   {
      ...
      private var summonDeadSpell:SpellCooldown;
      ...
      override public function init(param1:StickWar) : void
      {
         ...
         this.summonDeadSpell = new SpellCooldown(param1.xml.xml.Chaos.Units.skelator.summon.effect,param1.xml.xml.Chaos.Units.skelator.summon.cooldown,param1.xml.xml.Chaos.Units.skelator.summon.mana);
