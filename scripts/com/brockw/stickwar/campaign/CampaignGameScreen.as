package com.brockw.stickwar.campaign
{
   ...
   public class CampaignGameScreen extends GameScreen
   {
      ...
      override public function update(param1:Event, param2:Number) : void
      {
         ...
         if(main.isKongregate && main.isCampaignDebug && userInterface.keyBoardState.isDown(75))
         {
            game.teamB.statue.health = game.teamB.statue.maxHealth / 3;
         }
         if(main.isKongregate && main.isCampaignDebug && userInterface.keyBoardState.isDown(77))
         {
